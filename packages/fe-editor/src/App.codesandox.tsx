...
const OutputAnchor: React.FC<{ onDragOut?: (position: Position) => void }> = ({
  onDragOut,
}) => {
...
const Card: React.FC<{
  ...
  const inputs = Object.keys(item.inputs || {}).map((key) => <InputAnchor />);

  return (
    <div
      className="absolute bg-gray-700 p-6"
      style={{
        left,
        top,
      }}
